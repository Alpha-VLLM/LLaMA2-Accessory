...
resolution2scale = {
    ...
    512: ['1024 x 256', '1008 x 256', '992 x 256', '976 x 256', '960 x 256', '960 x 272',
          ...
          '512 x 512', '496 x 512', '496 x 528', '480 x 528', '480 x 544', '464 x 544',
          ...
          '256 x 1024'],
    1024: ['2048x512', '2032x512', '2016x512', '2000x512', '1984x512', '1984x528', '1968x528',
           ...
           '1056x976', '1056x992', '1040x992', '1040x1008', '1024x1008', '1024x1024', '1008x1024',
            ...
            with gr.Column():
                ...
                with gr.Row():
                    resolution = gr.Dropdown(
                        value="256x256",
                        choices=resolution2scale[args.resolution]
                    )
                with gr.Row():
